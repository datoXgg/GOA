...
print("With print u can display test in python")
...
#7 - Which is commonly used in Python for naming variables and functions, where words are separated by underscore?
Snake_case = "text"
print(Snake_case)

#8 - What is the primary purpose of adding comments to your Python code?
print("To show people who views code, what it does")
...
list = ["smth", "smth2", "smth3", "smth4", "smth5"]
print(list[1:4])
